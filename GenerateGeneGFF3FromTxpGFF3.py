# ### contain error
# ### error: input gff3 should be sorted
# ### error: output transcript, exon 2 line. Only exon line for now.
# ### Use GenerateGeneGff3.cpp instead
# import readline
# import re

# with open("../Drosophila_melanogaster.BDGP6.80_txp.gff3") as f:
