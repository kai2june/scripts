...
percent=0
tool="salmon"
index="txp.add_nascent.add_polyA125"
mode="idx"
branch=""
...
do
    ...
    then
        ...
        salmon quant -i /home/droso.reference/jimmy_salmon.txp.add_nascent.add_polyA125.index -l A -1 ../txpgene${percent}%_1.fasta -2 ../txpgene${percent}%_2.fasta -d -o jimmy_salmon.${index}.${mode}quant --transcriptome_size_no_nascent 34611 --add_nascent_threshold 1.0 --intron_read_percentage_in_nascent_at_least 1.0 --writeMappings jimmy_salmon.${index}.idxquant.sam
    elif [ ${mode} = "aln" ]
    then
