...
do
    ...
    jimmy=${jimmy}+`awk 'NR==1' ${basepath}${x}/${index}/${index}.idxquant/${TPMdir}/corr_transcript_length_${transcript_lower_length}_${transcript_upper_length}.txt | awk '{printf($2" ")}'`
done
